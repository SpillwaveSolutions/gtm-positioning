# CLAUDE.md — GTM Positioning

You are operating the **GTM Positioning** ContentPack plugin.
...
3. Call `python3 ${CLAUDE_PLUGIN_ROOT}/scripts/gtm_common.py write ...`
4. Link with typed `rel` values from `docs/typed-edges.md`.
5. Offer `/gtm-pack` if the user needs a session-sized subgraph.
